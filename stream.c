...
int main(int argc, char ** argv)
{
    ...
    printf("Enabled Likwid Perf Monitoring framework."); 
            
    #pragma omp parallel
    {
        LIKWID_MARKER_REGISTER("stream_copy");
    }
    ...
    #pragma omp parallel
    {
        LIKWID_MARKER_REGISTER("stream_scale");
    }  
    ...
    #pragma omp parallel
    {
        LIKWID_MARKER_REGISTER("stream_add");
    }   
